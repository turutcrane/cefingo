...
func cefingo_display_handler_on_status_message(
	...
	if f != nil {
		...
		Logf("T1019: on_status_message: Noo!")
	}
...
func cefingo_display_handler_on_console_message(
	...
	Tracef(unsafe.Pointer(self), "T1040:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1058: on_console_message: Noo!")
	}
	return cRet
}
...
func cefingo_display_handler_on_auto_resize(
	...
	Tracef(unsafe.Pointer(self), "T1078:")
	cefingoIfaceAccess.Lock()
...
func cefingo_display_handler_on_loading_progress_change(
	...
	Tracef(unsafe.Pointer(self), "T1111:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1125: on_loading_progress_change: Noo!")
	}
...
func cefingo_download_handler_on_before_download(
	...
	Tracef(unsafe.Pointer(self), "T1148:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1166: on_before_download: Noo!")
	}
...
func cefingo_download_handler_on_download_updated(
	...
	Tracef(unsafe.Pointer(self), "T1188:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1205: on_download_updated: Noo!")
	}
...
func cefingo_drag_handler_on_drag_enter(
	...
	Tracef(unsafe.Pointer(self), "T1226:")
	cefingoIfaceAccess.Lock()
...
func cefingo_drag_handler_on_draggable_regions_changed(
	...
	Tracef(unsafe.Pointer(self), "T1266:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1283: on_draggable_regions_changed: Noo!")
	}
...
func cefingo_extension_handler_on_extension_load_failed(
	...
	Tracef(unsafe.Pointer(self), "T1300:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1312: on_extension_load_failed: Noo!")
	}
...
func cefingo_extension_handler_on_extension_loaded(
	...
	Tracef(unsafe.Pointer(self), "T1329:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1342: on_extension_loaded: Noo!")
	}
...
func cefingo_extension_handler_on_extension_unloaded(
	...
	Tracef(unsafe.Pointer(self), "T1358:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1371: on_extension_unloaded: Noo!")
	}
...
func cefingo_extension_handler_on_before_background_browser(
	...
	Tracef(unsafe.Pointer(self), "T1402:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*settings = C.cef_browser_settings_t(_settings)
		...
		Logf("T1418: on_before_background_browser: Noo!")
	}
	return cRet
}
...
func cefingo_extension_handler_on_before_browser(
	...
	Tracef(unsafe.Pointer(self), "T1463:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*settings = C.cef_browser_settings_t(_settings)
		...
		Logf("T1485: on_before_browser: Noo!")
	}
	return cRet
}
...
func cefingo_extension_handler_get_active_browser(
	...
	if f != nil {
		...
		Logf("T1538: get_active_browser: Noo!")
	}
	return cRet
}
...
func cefingo_extension_handler_can_access_browser(
	...
	Tracef(unsafe.Pointer(self), "T1563:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1582: can_access_browser: Noo!")
	}
	return cRet
}
...
func cefingo_extension_handler_get_extension_resource(
	...
	Tracef(unsafe.Pointer(self), "T1608:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1627: get_extension_resource: Noo!")
	}
	return cRet
}
...
func cefingo_find_handler_on_find_result(
	...
	Tracef(unsafe.Pointer(self), "T1653:")
	cefingoIfaceAccess.Lock()
...
func cefingo_focus_handler_on_take_focus(
	...
	Tracef(unsafe.Pointer(self), "T1691:")
	cefingoIfaceAccess.Lock()
...
func cefingo_focus_handler_on_set_focus(
	...
	Tracef(unsafe.Pointer(self), "T1724:")
	cefingoIfaceAccess.Lock()
...
func cefingo_focus_handler_on_got_focus(
	...
	Tracef(unsafe.Pointer(self), "T1755:")
	cefingoIfaceAccess.Lock()
...
func cefingo_jsdialog_handler_on_jsdialog(
	...
	Tracef(unsafe.Pointer(self), "T1804:")
	cefingoIfaceAccess.Lock()
...
func cefingo_jsdialog_handler_on_before_unload_dialog(
	...
	Tracef(unsafe.Pointer(self), "T1851:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1869: on_before_unload_dialog: Noo!")
	}
	return cRet
}
...
func cefingo_jsdialog_handler_on_reset_dialog_state(
	...
	Tracef(unsafe.Pointer(self), "T1887:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1900: on_reset_dialog_state: Noo!")
	}
...
func cefingo_jsdialog_handler_on_dialog_closed(
	...
	Tracef(unsafe.Pointer(self), "T1916:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T1929: on_dialog_closed: Noo!")
	}
...
func cefingo_keyboard_handler_on_pre_key_event(
	...
	Tracef(unsafe.Pointer(self), "T1952:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*is_keyboard_shortcut = (C.int)(_is_keyboard_shortcut)
		...
		Logf("T1971: on_pre_key_event: Noo!")
	}
	return cRet
}
...
func cefingo_keyboard_handler_on_key_event(
	...
	Tracef(unsafe.Pointer(self), "T1992:")
	cefingoIfaceAccess.Lock()
...
func cefingo_life_span_handler_on_before_popup(
	...
	Tracef(unsafe.Pointer(self), "T2057:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*no_javascript_access = C.int(_no_javascript_access)
		...
		Logf("T2085: on_before_popup: Noo!")
	}
	return cRet
}
...
func cefingo_life_span_handler_on_after_created(
	...
	if f != nil {
		...
		Logf("T2130: on_after_created: Noo!")
	}
...
func cefingo_life_span_handler_do_close(
	...
	Tracef(unsafe.Pointer(self), "T2232:")
	cefingoIfaceAccess.Lock()
...
func cefingo_life_span_handler_on_before_close(
	...
	if f != nil {
		...
		Logf("T2283: on_before_close: Noo!")
	}
...
func cefingo_load_handler_on_loading_state_change(
	...
	Tracef(unsafe.Pointer(self), "T2306:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T2322: on_loading_state_change: Noo!")
	}
...
func cefingo_load_handler_on_load_start(
	...
	Tracef(unsafe.Pointer(self), "T2349:")
	cefingoIfaceAccess.Lock()
...
func cefingo_load_handler_on_load_end(
	...
	Tracef(unsafe.Pointer(self), "T2390:")
	cefingoIfaceAccess.Lock()
...
func cefingo_load_handler_on_load_error(
	...
	Tracef(unsafe.Pointer(self), "T2430:")
	cefingoIfaceAccess.Lock()
...
func cefingo_menu_model_delegate_execute_command(
	...
	Tracef(unsafe.Pointer(self), "T2467:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T2482: execute_command: Noo!")
	}
...
func cefingo_menu_model_delegate_mouse_outside_menu(
	...
	Tracef(unsafe.Pointer(self), "T2500:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T2514: mouse_outside_menu: Noo!")
	}
...
func cefingo_menu_model_delegate_unhandled_open_submenu(
	...
	Tracef(unsafe.Pointer(self), "T2532:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T2546: unhandled_open_submenu: Noo!")
	}
...
func cefingo_menu_model_delegate_unhandled_close_submenu(
	...
	Tracef(unsafe.Pointer(self), "T2564:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T2578: unhandled_close_submenu: Noo!")
	}
...
func cefingo_menu_model_delegate_menu_closed(
	...
	Tracef(unsafe.Pointer(self), "T2623:")
	cefingoIfaceAccess.Lock()
...
func cefingo_menu_model_delegate_format_label(
	...
	Tracef(unsafe.Pointer(self), "T2654:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_get_accessibility_handler(self *C.cef_render_handler_t) (ch *C.cef_accessibility_handler_t) {
	...
	if handler == nil {
		Logf("T2686: get_accessibility_handler")
	} else {
...
func cefingo_render_handler_get_root_screen_rect(
	...
	Tracef(unsafe.Pointer(self), "T2705:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T2720: get_root_screen_rect: Noo!")
	}
	return cRet
}
...
func cefingo_render_handler_get_view_rect(
	...
	Tracef(unsafe.Pointer(self), "T2738:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_get_screen_point(
	...
	Tracef(unsafe.Pointer(self), "T2773:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*screenY = (C.int)(_screenY)
		...
		Logf("T2795: get_screen_point: Noo!")
	}
	return cRet
}
...
func cefingo_render_handler_get_screen_info(
	...
	Tracef(unsafe.Pointer(self), "T2818:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T2833: get_screen_info: Noo!")
	}
	return cRet
}
...
func cefingo_render_handler_on_popup_show(
	...
	Tracef(unsafe.Pointer(self), "T2851:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_on_popup_size(
	...
	Tracef(unsafe.Pointer(self), "T2883:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_on_paint(
	...
	Tracef(unsafe.Pointer(self), "T2927:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_on_accelerated_paint(
	...
	Tracef(unsafe.Pointer(self), "T2972:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T2989: on_accelerated_paint: Noo!")
	}
...
func cefingo_render_handler_on_cursor_change(
	...
	Tracef(unsafe.Pointer(self), "T3009:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3025: on_cursor_change: Noo!")
	}
...
func cefingo_render_handler_start_dragging(
	...
	Tracef(unsafe.Pointer(self), "T3056:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_update_drag_cursor(
	...
	Tracef(unsafe.Pointer(self), "T3094:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3108: update_drag_cursor: Noo!")
	}
...
func cefingo_render_handler_on_scroll_offset_changed(
	...
	Tracef(unsafe.Pointer(self), "T3126:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3141: on_scroll_offset_changed: Noo!")
	}
...
func cefingo_render_handler_on_ime_composition_range_changed(
	...
	Tracef(unsafe.Pointer(self), "T3162:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3178: on_ime_composition_range_changed: Noo!")
	}
...
func cefingo_render_handler_on_text_selection_changed(
	...
	Tracef(unsafe.Pointer(self), "T3198:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3213: on_text_selection_changed: Noo!")
	}
...
func cefingo_render_handler_on_virtual_keyboard_requested(
	...
	Tracef(unsafe.Pointer(self), "T3233:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3247: on_virtual_keyboard_requested: Noo!")
	}
...
func cefingo_render_process_handler_on_render_thread_created(
	...
	Tracef(unsafe.Pointer(self), "T3281:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3294: on_render_thread_created: Noo!")
	}
...
func cefingo_render_process_handler_on_web_kit_initialized(
	...
	Tracef(unsafe.Pointer(self), "T3309:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3320: on_web_kit_initialized: Noo!")
	}
...
func cefingo_render_process_handler_on_browser_created(
	...
	Tracef(unsafe.Pointer(self), "T3343:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3358: on_browser_created: Noo!")
	}
...
func cefingo_render_process_handler_on_browser_destroyed(
	...
	Tracef(unsafe.Pointer(self), "T3374:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3387: on_browser_destroyed: Noo!")
	}
...
func cefingo_render_process_handler_on_context_created(
	...
	Tracef(unsafe.Pointer(self), "T3410:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3427: on_context_created: Noo!")
	}
...
func cefingo_render_process_handler_on_context_released(
	...
	Tracef(unsafe.Pointer(self), "T3446:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3463: on_context_released: Noo!")
	}
...
func cefingo_render_process_handler_on_uncaught_exception(
	...
	Tracef(unsafe.Pointer(self), "T3485:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3506: on_uncaught_exception: Noo!")
	}
...
func cefingo_render_process_handler_on_focused_node_changed(
	...
	Tracef(unsafe.Pointer(self), "T3529:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3546: on_focused_node_changed: Noo!")
	}
...
func cefingo_render_process_handler_on_process_message_received(
	...
	Tracef(unsafe.Pointer(self), "T3567:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3586: on_process_message_received: Noo!")
	}
	return cRet
}
...
func cefingo_request_context_handler_get_resource_request_handler(self *C.cef_request_context_handler_t) (ch *C.cef_resource_request_handler_t) {
	...
	if handler == nil {
		Logf("T3601: get_resource_request_handler")
	} else {
...
func cefingo_request_context_handler_on_request_context_initialized(
	...
	if f != nil {
		...
		Logf("T3631: on_request_context_initialized: Noo!")
	}
...
func cefingo_request_context_handler_on_before_plugin_load(
	...
	Tracef(unsafe.Pointer(self), "T3668:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*plugin_policy = (C.cef_plugin_policy_t)(_plugin_policy)
		...
		Logf("T3689: on_before_plugin_load: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_get_resource_request_handler(self *C.cef_request_handler_t) (ch *C.cef_resource_request_handler_t) {
	...
	if handler == nil {
		Logf("T3704: get_resource_request_handler")
	} else {
		BaseAddRef(handler.p_resource_request_handler)
		ch = handler.p_resource_request_handler
	}
...
func cefingo_request_handler_on_before_browse(
	...
	Tracef(unsafe.Pointer(self), "T3733:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3753: on_before_browse: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_open_urlfrom_tab(
	...
	Tracef(unsafe.Pointer(self), "T3786:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3805: on_open_urlfrom_tab: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_get_auth_credentials(
	...
	Tracef(unsafe.Pointer(self), "T3837:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3859: get_auth_credentials: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_quota_request(
	...
	Tracef(unsafe.Pointer(self), "T3884:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3902: on_quota_request: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_certificate_error(
	...
	Tracef(unsafe.Pointer(self), "T3927:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3947: on_certificate_error: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_select_client_certificate(
	...
	Tracef(unsafe.Pointer(self), "T3979:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3998: on_select_client_certificate: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_plugin_crashed(
	...
	if f != nil {
		...
		Logf("T4035: on_plugin_crashed: Noo!")
	}
...
func cefingo_request_handler_on_render_view_ready(
	...
	Tracef(unsafe.Pointer(self), "T4053:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4066: on_render_view_ready: Noo!")
	}
...
func cefingo_request_handler_on_render_process_terminated(
	...
	Tracef(unsafe.Pointer(self), "T4084:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4098: on_render_process_terminated: Noo!")
	}
...
func cefingo_resource_bundle_handler_get_localized_string(
	...
	if f != nil {
		...
		Logf("T4134: get_localized_string: Noo!")
	}
	return cRet
}
...
func cefingo_resource_handler_open(
	...
	Tracef(unsafe.Pointer(self), "T4159:")
	cefingoIfaceAccess.Lock()
...
func cefingo_resource_handler_process_request(
	...
	Tracef(unsafe.Pointer(self), "T4201:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4217: process_request: Noo!")
	}
	return cRet
}
...
func cefingo_resource_handler_get_response_headers(
	...
	Tracef(unsafe.Pointer(self), "T4247:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4264: get_response_headers: Noo!")
	}
...
func cefingo_resource_handler_skip(
	...
	Tracef(unsafe.Pointer(self), "T4288:")
	cefingoIfaceAccess.Lock()
...
func cefingo_resource_handler_read(
	...
	Tracef(unsafe.Pointer(self), "T4333:")
	cefingoIfaceAccess.Lock()
...
func cefingo_resource_handler_cancel(
	...
	Tracef(unsafe.Pointer(self), "T4409:")
	cefingoIfaceAccess.Lock()
...
func cefingo_scheme_handler_factory_create(
	...
	Tracef(unsafe.Pointer(self), "T4444:")
	cefingoIfaceAccess.Lock()
...
func cefingo_v8handler_execute(
	...
	Tracef(unsafe.Pointer(self), "T4489:")
	cefingoIfaceAccess.Lock()
...
func cefingo_v8array_buffer_release_callback_release_buffer(
	...
	Tracef(unsafe.Pointer(self), "T4536:")
	cefingoIfaceAccess.Lock()

...
func cefingo_life_span_handler_on_after_created(
	...
	if f != nil {
		...
		Logf("T3056: on_after_created: Noo!")
	}
...
func cefingo_life_span_handler_do_close(
	...
	Tracef(unsafe.Pointer(self), "T3158:")
	cefingoIfaceAccess.Lock()
...
func cefingo_life_span_handler_on_before_close(
	...
	Tracef(unsafe.Pointer(self), "T3196:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3209: on_before_close: Noo!")
	}
...
func cefingo_load_handler_on_loading_state_change(
	...
	Tracef(unsafe.Pointer(self), "T3232:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3248: on_loading_state_change: Noo!")
	}
...
func cefingo_load_handler_on_load_start(
	...
	Tracef(unsafe.Pointer(self), "T3275:")
	cefingoIfaceAccess.Lock()
...
func cefingo_load_handler_on_load_end(
	...
	Tracef(unsafe.Pointer(self), "T3316:")
	cefingoIfaceAccess.Lock()
...
func cefingo_load_handler_on_load_error(
	...
	Tracef(unsafe.Pointer(self), "T3356:")
	cefingoIfaceAccess.Lock()
...
func cefingo_media_observer_on_sinks(
	...
	Tracef(unsafe.Pointer(self), "T3392:")
	cefingoIfaceAccess.Lock()
...
func cefingo_media_observer_on_routes(
	...
	Tracef(unsafe.Pointer(self), "T3426:")
	cefingoIfaceAccess.Lock()
...
func cefingo_media_observer_on_route_state_changed(
	...
	Tracef(unsafe.Pointer(self), "T3459:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3473: on_route_state_changed: Noo!")
	}
...
func cefingo_media_observer_on_route_message_received(
	...
	Tracef(unsafe.Pointer(self), "T3492:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3507: on_route_message_received: Noo!")
	}
...
func cefingo_menu_button_delegate_on_menu_button_pressed(
	...
	Tracef(unsafe.Pointer(self), "T3528:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3544: on_menu_button_pressed: Noo!")
	}
...
func cefingo_menu_button_delegate_on_button_pressed(
	...
	Tracef(unsafe.Pointer(self), "T3560:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3573: on_button_pressed: Noo!")
	}
...
func cefingo_menu_button_delegate_on_button_state_changed(
	...
	Tracef(unsafe.Pointer(self), "T3589:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3602: on_button_state_changed: Noo!")
	}
...
func cefingo_menu_button_delegate_get_preferred_size(
	...
	Tracef(unsafe.Pointer(self), "T3615:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3629: get_preferred_size: Noo!")
	}
	return cRet
}
...
func cefingo_menu_button_delegate_get_minimum_size(
	...
	Tracef(unsafe.Pointer(self), "T3642:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3656: get_minimum_size: Noo!")
	}
	return cRet
}
...
func cefingo_menu_button_delegate_get_maximum_size(
	...
	Tracef(unsafe.Pointer(self), "T3669:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3683: get_maximum_size: Noo!")
	}
	return cRet
}
...
func cefingo_menu_button_delegate_get_height_for_width(
	...
	Tracef(unsafe.Pointer(self), "T3697:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3712: get_height_for_width: Noo!")
	}
	return cRet
}
...
func cefingo_menu_button_delegate_on_parent_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T3727:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3743: on_parent_view_changed: Noo!")
	}
...
func cefingo_menu_button_delegate_on_child_view_changed(
	...
	if f != nil {
		...
		Logf("T3774: on_child_view_changed: Noo!")
	}
...
func cefingo_menu_button_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T3787:")
	cefingoIfaceAccess.Lock()
...
func cefingo_menu_button_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T3813:")
	cefingoIfaceAccess.Lock()
...
func cefingo_menu_model_delegate_execute_command(
	...
	Tracef(unsafe.Pointer(self), "T3845:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3860: execute_command: Noo!")
	}
...
func cefingo_menu_model_delegate_mouse_outside_menu(
	...
	Tracef(unsafe.Pointer(self), "T3878:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3892: mouse_outside_menu: Noo!")
	}
...
func cefingo_menu_model_delegate_unhandled_open_submenu(
	...
	Tracef(unsafe.Pointer(self), "T3910:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3924: unhandled_open_submenu: Noo!")
	}
...
func cefingo_menu_model_delegate_unhandled_close_submenu(
	...
	Tracef(unsafe.Pointer(self), "T3942:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T3956: unhandled_close_submenu: Noo!")
	}
...
func cefingo_menu_model_delegate_menu_will_show(
	...
	Tracef(unsafe.Pointer(self), "T3972:")
	cefingoIfaceAccess.Lock()
...
func cefingo_menu_model_delegate_menu_closed(
	...
	Tracef(unsafe.Pointer(self), "T4001:")
	cefingoIfaceAccess.Lock()
...
func cefingo_menu_model_delegate_format_label(
	...
	Tracef(unsafe.Pointer(self), "T4032:")
	cefingoIfaceAccess.Lock()
...
func cefingo_panel_delegate_get_preferred_size(
	...
	if f != nil {
		...
		Logf("T4075: get_preferred_size: Noo!")
	}
	return cRet
}
...
func cefingo_panel_delegate_get_minimum_size(
	...
	Tracef(unsafe.Pointer(self), "T4088:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4102: get_minimum_size: Noo!")
	}
	return cRet
}
...
func cefingo_panel_delegate_get_maximum_size(
	...
	if f != nil {
		...
		Logf("T4129: get_maximum_size: Noo!")
	}
	return cRet
}
...
func cefingo_panel_delegate_get_height_for_width(
	...
	Tracef(unsafe.Pointer(self), "T4143:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4158: get_height_for_width: Noo!")
	}
	return cRet
}
...
func cefingo_panel_delegate_on_parent_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T4173:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4189: on_parent_view_changed: Noo!")
	}
...
func cefingo_panel_delegate_on_child_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T4204:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4220: on_child_view_changed: Noo!")
	}
...
func cefingo_panel_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T4233:")
	cefingoIfaceAccess.Lock()
...
func cefingo_print_handler_on_print_start(
	...
	Tracef(unsafe.Pointer(self), "T4291:")
	cefingoIfaceAccess.Lock()
...
func cefingo_print_handler_on_print_settings(
	...
	Tracef(unsafe.Pointer(self), "T4324:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4340: on_print_settings: Noo!")
	}
...
func cefingo_print_handler_on_print_dialog(
	...
	Tracef(unsafe.Pointer(self), "T4360:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4377: on_print_dialog: Noo!")
	}
	return cRet
}
...
func cefingo_print_handler_on_print_job(
	...
	Tracef(unsafe.Pointer(self), "T4398:")
	cefingoIfaceAccess.Lock()
...
func cefingo_print_handler_on_print_reset(
	...
	Tracef(unsafe.Pointer(self), "T4432:")
	cefingoIfaceAccess.Lock()
...
func cefingo_print_handler_get_pdf_paper_size(
	...
	Tracef(unsafe.Pointer(self), "T4462:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4475: get_pdf_paper_size: Noo!")
	}
	return cRet
}
...
func cefingo_render_handler_get_accessibility_handler(self *C.cef_render_handler_t) (ch *C.cef_accessibility_handler_t) {
	...
	if handler == nil {
		Logf("T4490: get_accessibility_handler")
	} else {
...
func cefingo_render_handler_get_root_screen_rect(
	...
	Tracef(unsafe.Pointer(self), "T4509:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*rect = (C.cef_rect_t)(goTmprectOut)
		...
		Logf("T4524: get_root_screen_rect: Noo!")
	}
	return cRet
}
...
func cefingo_render_handler_get_view_rect(
	...
	Tracef(unsafe.Pointer(self), "T4542:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_get_screen_point(
	...
	Tracef(unsafe.Pointer(self), "T4577:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*screenY = (C.int)(goTmpscreenYOut)
		...
		Logf("T4595: get_screen_point: Noo!")
	}
	return cRet
}
...
func cefingo_render_handler_get_screen_info(
	...
	Tracef(unsafe.Pointer(self), "T4618:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4633: get_screen_info: Noo!")
	}
	return cRet
}
...
func cefingo_render_handler_on_popup_show(
	...
	Tracef(unsafe.Pointer(self), "T4651:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_on_popup_size(
	...
	Tracef(unsafe.Pointer(self), "T4683:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_on_paint(
	...
	Tracef(unsafe.Pointer(self), "T4727:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_on_accelerated_paint(
	...
	Tracef(unsafe.Pointer(self), "T4772:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4789: on_accelerated_paint: Noo!")
	}
...
func cefingo_render_handler_on_cursor_change(
	...
	if f != nil {
		...
		Logf("T4825: on_cursor_change: Noo!")
	}
...
func cefingo_render_handler_start_dragging(
	...
	Tracef(unsafe.Pointer(self), "T4856:")
	cefingoIfaceAccess.Lock()
...
func cefingo_render_handler_update_drag_cursor(
	...
	Tracef(unsafe.Pointer(self), "T4894:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4908: update_drag_cursor: Noo!")
	}
...
func cefingo_render_handler_on_scroll_offset_changed(
	...
	Tracef(unsafe.Pointer(self), "T4926:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T4941: on_scroll_offset_changed: Noo!")
	}
...
func cefingo_render_handler_on_ime_composition_range_changed(
	...
	if f != nil {
		...
		Logf("T4978: on_ime_composition_range_changed: Noo!")
	}
...
func cefingo_render_handler_on_text_selection_changed(
	...
	Tracef(unsafe.Pointer(self), "T4998:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5013: on_text_selection_changed: Noo!")
	}
...
func cefingo_render_handler_on_virtual_keyboard_requested(
	...
	Tracef(unsafe.Pointer(self), "T5033:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5047: on_virtual_keyboard_requested: Noo!")
	}
...
func cefingo_render_process_handler_on_render_thread_created(
	...
	Tracef(unsafe.Pointer(self), "T5081:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5094: on_render_thread_created: Noo!")
	}
...
func cefingo_render_process_handler_on_web_kit_initialized(
	...
	Tracef(unsafe.Pointer(self), "T5109:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5120: on_web_kit_initialized: Noo!")
	}
...
func cefingo_render_process_handler_on_browser_created(
	...
	Tracef(unsafe.Pointer(self), "T5143:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5158: on_browser_created: Noo!")
	}
...
func cefingo_render_process_handler_on_browser_destroyed(
	...
	Tracef(unsafe.Pointer(self), "T5174:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5187: on_browser_destroyed: Noo!")
	}
...
func cefingo_render_process_handler_on_context_created(
	...
	Tracef(unsafe.Pointer(self), "T5210:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5227: on_context_created: Noo!")
	}
...
func cefingo_render_process_handler_on_context_released(
	...
	Tracef(unsafe.Pointer(self), "T5246:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5263: on_context_released: Noo!")
	}
...
func cefingo_render_process_handler_on_uncaught_exception(
	...
	Tracef(unsafe.Pointer(self), "T5285:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5306: on_uncaught_exception: Noo!")
	}
...
func cefingo_render_process_handler_on_focused_node_changed(
	...
	Tracef(unsafe.Pointer(self), "T5329:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5346: on_focused_node_changed: Noo!")
	}
...
func cefingo_render_process_handler_on_process_message_received(
	...
	Tracef(unsafe.Pointer(self), "T5367:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5386: on_process_message_received: Noo!")
	}
	return cRet
}
...
func cefingo_request_context_handler_on_request_context_initialized(
	...
	Tracef(unsafe.Pointer(self), "T5403:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5416: on_request_context_initialized: Noo!")
	}
...
func cefingo_request_context_handler_on_before_plugin_load(
	...
	Tracef(unsafe.Pointer(self), "T5453:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*plugin_policy = (C.cef_plugin_policy_t)(goTmpplugin_policyOut)
		...
		Logf("T5472: on_before_plugin_load: Noo!")
	}
	return cRet
}
...
func cefingo_request_context_handler_get_resource_request_handler(
	...
	Tracef(unsafe.Pointer(self), "T5509:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*disable_default_handling = (C.int)(goTmpdisable_default_handlingOut)
		...
		Logf("T5531: get_resource_request_handler: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_before_browse(
	...
	Tracef(unsafe.Pointer(self), "T5561:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5581: on_before_browse: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_open_urlfrom_tab(
	...
	Tracef(unsafe.Pointer(self), "T5614:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5633: on_open_urlfrom_tab: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_get_resource_request_handler(
	...
	Tracef(unsafe.Pointer(self), "T5668:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*disable_default_handling = (C.int)(goTmpdisable_default_handlingOut)
		...
		Logf("T5690: get_resource_request_handler: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_get_auth_credentials(
	...
	Tracef(unsafe.Pointer(self), "T5723:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5745: get_auth_credentials: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_quota_request(
	...
	Tracef(unsafe.Pointer(self), "T5770:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5788: on_quota_request: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_certificate_error(
	...
	Tracef(unsafe.Pointer(self), "T5813:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5833: on_certificate_error: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_select_client_certificate(
	...
	Tracef(unsafe.Pointer(self), "T5865:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5884: on_select_client_certificate: Noo!")
	}
	return cRet
}
...
func cefingo_request_handler_on_plugin_crashed(
	...
	Tracef(unsafe.Pointer(self), "T5907:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5921: on_plugin_crashed: Noo!")
	}
...
func cefingo_request_handler_on_render_view_ready(
	...
	Tracef(unsafe.Pointer(self), "T5939:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T5952: on_render_view_ready: Noo!")
	}
...
func cefingo_request_handler_on_render_process_terminated(
	...
	if f != nil {
		...
		Logf("T5984: on_render_process_terminated: Noo!")
	}
...
func cefingo_resource_bundle_handler_get_localized_string(
	...
	if f != nil {
		...
		Logf("T6018: get_localized_string: Noo!")
	}
	return cRet
}
...
func cefingo_resource_bundle_handler_get_data_resource(
	...
	Tracef(unsafe.Pointer(self), "T6041:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*data = (C.VOIDP)(C.calloc(1, C.size_t(len(goTmpdataOut))))
		...
		Logf("T6055: get_data_resource: Noo!")
	}
	return cRet
}
...
func cefingo_resource_bundle_handler_get_data_resource_for_scale(
	...
	Tracef(unsafe.Pointer(self), "T6082:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*data = (C.VOIDP)(C.calloc(1, C.size_t(len(goTmpdataOut))))
		...
		Logf("T6097: get_data_resource_for_scale: Noo!")
	}
	return cRet
}
...
func cefingo_resource_handler_open(
	...
	Tracef(unsafe.Pointer(self), "T6125:")
	cefingoIfaceAccess.Lock()
...
func cefingo_resource_handler_process_request(
	...
	Tracef(unsafe.Pointer(self), "T6165:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6181: process_request: Noo!")
	}
	return cRet
}
...
func cefingo_resource_handler_get_response_headers(
	...
	Tracef(unsafe.Pointer(self), "T6211:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*response_length = (C.int64)(goTmpresponse_lengthOut)
		...
		Logf("T6226: get_response_headers: Noo!")
	}
...
func cefingo_resource_handler_skip(
	...
	Tracef(unsafe.Pointer(self), "T6250:")
	cefingoIfaceAccess.Lock()
...
func cefingo_resource_handler_read_response(
	...
	Tracef(unsafe.Pointer(self), "T6336:")
	cefingoIfaceAccess.Lock()
...
func cefingo_resource_handler_cancel(
	...
	Tracef(unsafe.Pointer(self), "T6367:")
	cefingoIfaceAccess.Lock()
...
func cefingo_resource_request_handler_get_cookie_access_filter(
	...
	Tracef(unsafe.Pointer(self), "T6401:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6419: get_cookie_access_filter: Noo!")
	}
	return cRet
}
...
func cefingo_resource_request_handler_on_before_resource_load(
	...
	Tracef(unsafe.Pointer(self), "T6447:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6467: on_before_resource_load: Noo!")
	}
	return cRet
}
...
func cefingo_resource_request_handler_get_resource_handler(
	...
	Tracef(unsafe.Pointer(self), "T6490:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6508: get_resource_handler: Noo!")
	}
	return cRet
}
...
func cefingo_resource_request_handler_on_resource_redirect(
	...
	Tracef(unsafe.Pointer(self), "T6536:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6556: on_resource_redirect: Noo!")
	}
...
func cefingo_resource_request_handler_on_resource_response(
	...
	Tracef(unsafe.Pointer(self), "T6585:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6605: on_resource_response: Noo!")
	}
	return cRet
}
...
func cefingo_resource_request_handler_get_resource_response_filter(
	...
	Tracef(unsafe.Pointer(self), "T6628:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6648: get_resource_response_filter: Noo!")
	}
	return cRet
}
...
func cefingo_resource_request_handler_on_resource_load_complete(
	...
	Tracef(unsafe.Pointer(self), "T6683:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6704: on_resource_load_complete: Noo!")
	}
...
func cefingo_resource_request_handler_on_protocol_execution(
	...
	Tracef(unsafe.Pointer(self), "T6730:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*allow_os_execution = (C.int)(goTmpallow_os_executionOut)
		...
		Logf("T6748: on_protocol_execution: Noo!")
	}
...
func cefingo_cookie_access_filter_can_send_cookie(
	...
	Tracef(unsafe.Pointer(self), "T6771:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6790: can_send_cookie: Noo!")
	}
	return cRet
}
...
func cefingo_cookie_access_filter_can_save_cookie(
	...
	Tracef(unsafe.Pointer(self), "T6815:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T6836: can_save_cookie: Noo!")
	}
	return cRet
}
...
func cefingo_response_filter_init_filter(
	...
	Tracef(unsafe.Pointer(self), "T6852:")
	cefingoIfaceAccess.Lock()
...
func cefingo_response_filter_filter(
	...
	Tracef(unsafe.Pointer(self), "T6913:")
	cefingoIfaceAccess.Lock()
...
func cefingo_scheme_handler_factory_create(
	...
	Tracef(unsafe.Pointer(self), "T6953:")
	cefingoIfaceAccess.Lock()
...
func cefingo_read_handler_read(
	...
	Tracef(unsafe.Pointer(self), "T6991:")
	cefingoIfaceAccess.Lock()
...
func cefingo_read_handler_tell(
	...
	Tracef(unsafe.Pointer(self), "T7053:")
	cefingoIfaceAccess.Lock()
...
func cefingo_read_handler_eof(
	...
	Tracef(unsafe.Pointer(self), "T7080:")
	cefingoIfaceAccess.Lock()
...
func cefingo_read_handler_may_block(
	...
	Tracef(unsafe.Pointer(self), "T7109:")
	cefingoIfaceAccess.Lock()
...
func cefingo_write_handler_write(
	...
	Tracef(unsafe.Pointer(self), "T7139:")
	cefingoIfaceAccess.Lock()
...
func cefingo_write_handler_tell(
	...
	Tracef(unsafe.Pointer(self), "T7201:")
	cefingoIfaceAccess.Lock()
...
func cefingo_write_handler_flush(
	...
	Tracef(unsafe.Pointer(self), "T7228:")
	cefingoIfaceAccess.Lock()
...
func cefingo_write_handler_may_block(
	...
	Tracef(unsafe.Pointer(self), "T7257:")
	cefingoIfaceAccess.Lock()
...
func cefingo_string_visitor_visit(
	...
	Tracef(unsafe.Pointer(self), "T7285:")
	cefingoIfaceAccess.Lock()
...
func cefingo_task_execute(
	...
	Tracef(unsafe.Pointer(self), "T7312:")
	cefingoIfaceAccess.Lock()
...
func cefingo_textfield_delegate_on_key_event(
	...
	Tracef(unsafe.Pointer(self), "T7342:")
	cefingoIfaceAccess.Lock()
...
func cefingo_textfield_delegate_on_after_user_action(
	...
	Tracef(unsafe.Pointer(self), "T7373:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7386: on_after_user_action: Noo!")
	}
...
func cefingo_textfield_delegate_get_preferred_size(
	...
	Tracef(unsafe.Pointer(self), "T7399:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7413: get_preferred_size: Noo!")
	}
	return cRet
}
...
func cefingo_textfield_delegate_get_minimum_size(
	...
	Tracef(unsafe.Pointer(self), "T7426:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7440: get_minimum_size: Noo!")
	}
	return cRet
}
...
func cefingo_textfield_delegate_get_maximum_size(
	...
	Tracef(unsafe.Pointer(self), "T7453:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7467: get_maximum_size: Noo!")
	}
	return cRet
}
...
func cefingo_textfield_delegate_get_height_for_width(
	...
	Tracef(unsafe.Pointer(self), "T7481:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7496: get_height_for_width: Noo!")
	}
	return cRet
}
...
func cefingo_textfield_delegate_on_parent_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T7511:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7527: on_parent_view_changed: Noo!")
	}
...
func cefingo_textfield_delegate_on_child_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T7542:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7558: on_child_view_changed: Noo!")
	}
...
func cefingo_textfield_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T7571:")
	cefingoIfaceAccess.Lock()
...
func cefingo_textfield_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T7597:")
	cefingoIfaceAccess.Lock()
...
func cefingo_urlrequest_client_on_request_complete(
	...
	Tracef(unsafe.Pointer(self), "T7628:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7641: on_request_complete: Noo!")
	}
...
func cefingo_urlrequest_client_on_upload_progress(
	...
	Tracef(unsafe.Pointer(self), "T7662:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7677: on_upload_progress: Noo!")
	}
...
func cefingo_urlrequest_client_on_download_progress(
	...
	Tracef(unsafe.Pointer(self), "T7697:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7712: on_download_progress: Noo!")
	}
...
func cefingo_urlrequest_client_on_download_data(
	...
	Tracef(unsafe.Pointer(self), "T7732:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7747: on_download_data: Noo!")
	}
...
func cefingo_urlrequest_client_get_auth_credentials(
	...
	Tracef(unsafe.Pointer(self), "T7776:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7795: get_auth_credentials: Noo!")
	}
	return cRet
}
...
func cefingo_v8handler_execute(
	...
	Tracef(unsafe.Pointer(self), "T7820:")
	cefingoIfaceAccess.Lock()
...
func cefingo_v8accessor_get(
	...
	Tracef(unsafe.Pointer(self), "T7868:")
	cefingoIfaceAccess.Lock()
...
func cefingo_v8accessor_set(
	...
	Tracef(unsafe.Pointer(self), "T7911:")
	cefingoIfaceAccess.Lock()
...
func cefingo_v8array_buffer_release_callback_release_buffer(
	...
	Tracef(unsafe.Pointer(self), "T7947:")
	cefingoIfaceAccess.Lock()
...
func cefingo_view_delegate_get_preferred_size(
	...
	Tracef(unsafe.Pointer(self), "T7976:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T7990: get_preferred_size: Noo!")
	}
	return cRet
}
...
func cefingo_view_delegate_get_minimum_size(
	...
	Tracef(unsafe.Pointer(self), "T8006:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8020: get_minimum_size: Noo!")
	}
	return cRet
}
...
func cefingo_view_delegate_get_maximum_size(
	...
	Tracef(unsafe.Pointer(self), "T8036:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8050: get_maximum_size: Noo!")
	}
	return cRet
}
...
func cefingo_view_delegate_get_height_for_width(
	...
	Tracef(unsafe.Pointer(self), "T8070:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8085: get_height_for_width: Noo!")
	}
	return cRet
}
...
func cefingo_view_delegate_on_parent_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T8107:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8123: on_parent_view_changed: Noo!")
	}
...
func cefingo_view_delegate_on_child_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T8146:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8162: on_child_view_changed: Noo!")
	}
...
func cefingo_view_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T8178:")
	cefingoIfaceAccess.Lock()
...
func cefingo_view_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T8207:")
	cefingoIfaceAccess.Lock()
...
func cefingo_web_plugin_info_visitor_visit(
	...
	Tracef(unsafe.Pointer(self), "T8241:")
	cefingoIfaceAccess.Lock()
...
func cefingo_web_plugin_unstable_callback_is_unstable(
	...
	Tracef(unsafe.Pointer(self), "T8276:")
	cefingoIfaceAccess.Lock()
...
func cefingo_register_cdm_callback_on_cdm_registration_complete(
	...
	if f != nil {
		...
		Logf("T8322: on_cdm_registration_complete: Noo!")
	}
...
func cefingo_window_delegate_on_window_created(
	...
	Tracef(unsafe.Pointer(self), "T8338:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8351: on_window_created: Noo!")
	}
...
func cefingo_window_delegate_on_window_destroyed(
	...
	Tracef(unsafe.Pointer(self), "T8369:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8382: on_window_destroyed: Noo!")
	}
...
func cefingo_window_delegate_get_parent_window(
	...
	Tracef(unsafe.Pointer(self), "T8405:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		*can_activate_menu = 0
		...
		Logf("T8419: get_parent_window: Noo!")
	}
	return cRet
}
...
func cefingo_window_delegate_is_frameless(
	...
	Tracef(unsafe.Pointer(self), "T8446:")
	cefingoIfaceAccess.Lock()
...
func cefingo_window_delegate_can_resize(
	...
	Tracef(unsafe.Pointer(self), "T8476:")
	cefingoIfaceAccess.Lock()
...
func cefingo_window_delegate_can_maximize(
	...
	Tracef(unsafe.Pointer(self), "T8506:")
	cefingoIfaceAccess.Lock()
...
func cefingo_window_delegate_can_minimize(
	...
	Tracef(unsafe.Pointer(self), "T8536:")
	cefingoIfaceAccess.Lock()
...
func cefingo_window_delegate_can_close(
	...
	Tracef(unsafe.Pointer(self), "T8567:")
	cefingoIfaceAccess.Lock()
...
func cefingo_window_delegate_on_key_event(
	...
	Tracef(unsafe.Pointer(self), "T8634:")
	cefingoIfaceAccess.Lock()
...
func cefingo_window_delegate_get_preferred_size(
	...
	Tracef(unsafe.Pointer(self), "T8666:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8680: get_preferred_size: Noo!")
	}
	return cRet
}
...
func cefingo_window_delegate_get_minimum_size(
	...
	Tracef(unsafe.Pointer(self), "T8696:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8710: get_minimum_size: Noo!")
	}
	return cRet
}
...
func cefingo_window_delegate_get_maximum_size(
	...
	Tracef(unsafe.Pointer(self), "T8726:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8740: get_maximum_size: Noo!")
	}
	return cRet
}
...
func cefingo_window_delegate_get_height_for_width(
	...
	Tracef(unsafe.Pointer(self), "T8760:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8775: get_height_for_width: Noo!")
	}
	return cRet
}
...
func cefingo_window_delegate_on_parent_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T8797:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8813: on_parent_view_changed: Noo!")
	}
...
func cefingo_window_delegate_on_child_view_changed(
	...
	Tracef(unsafe.Pointer(self), "T8836:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T8852: on_child_view_changed: Noo!")
	}
...
func cefingo_window_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T8868:")
	cefingoIfaceAccess.Lock()
...
func cefingo_window_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T8897:")
	cefingoIfaceAccess.Lock()

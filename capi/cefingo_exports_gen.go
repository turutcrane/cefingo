...
// /
//
//export cefingo_browser_process_handler_on_register_custom_preferences
func cefingo_browser_process_handler_on_register_custom_preferences(
	self *C.cef_browser_process_handler_t,
	ctype C.cef_preferences_type_t,
	registrar *C.cef_preference_registrar_t,
) {
	runtime.LockOSThread()
	defer runtime.UnlockOSThread()
	...
	cefingoIfaceAccess.Lock()
	f := browser_process_handler_handlers.on_register_custom_preferences_handler[(*cCBrowserProcessHandlerT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		// !p.IsOutParam
		goTmptype := CPreferencesTypeT(ctype)
		// !p.IsOutParam
		goTmpregistrar := newCPreferenceRegistrarT(registrar)

		f.OnRegisterCustomPreferences(goTmpself, goTmptype, goTmpregistrar)

	} else {
		Logf("T112.6: on_register_custom_preferences: Noo!")
	}
...
func cefingo_browser_process_handler_on_context_initialized(
	...
	if f != nil {
		...
		Logf("T112.8: on_context_initialized: Noo!")
	}
...
func cefingo_browser_process_handler_on_before_child_process_launch(
	...
	if f != nil {
		...
		Logf("T112.10: on_before_child_process_launch: Noo!")
	}
	BaseRelease((*cCCommandLineT)(command_line)) // byApi
...
func cefingo_browser_process_handler_on_schedule_message_pump_work(
	...
	if f != nil {
		...
		Logf("T112.12: on_schedule_message_pump_work: Noo!")
	}
...
func cefingo_browser_process_handler_get_default_client(
	...
	Tracef(unsafe.Pointer(self), "T112.13:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T112.14: get_default_client: Noo!")
	}
...
// /
//
//export cefingo_client_get_permission_handler
func cefingo_client_get_permission_handler(
	self *C.cef_client_t,
) (cRet *C.cef_permission_handler_t) {
	runtime.LockOSThread()
	defer runtime.UnlockOSThread()

	Tracef(unsafe.Pointer(self), "T119.25:")
	cefingoIfaceAccess.Lock()
	f := client_handlers.get_permission_handler_handler[(*cCClientT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		goRet := f.GetPermissionHandler(goTmpself)

		if goRet != nil {
			if goRet.beUnrefed != byCef {
				BaseAddRef(goRet.pc_permission_handler) // return GoObj
			}
			cRet = (*C.cef_permission_handler_t)(goRet.pc_permission_handler)
		}
	} else {
		Logf("T119.26: get_permission_handler: Noo!")
	}
...
func cefingo_client_get_jsdialog_handler(
	...
	if f != nil {
		...
		Logf("T119.28: get_jsdialog_handler: Noo!")
	}
...
func cefingo_client_get_keyboard_handler(
	...
	if f != nil {
		...
		Logf("T119.30: get_keyboard_handler: Noo!")
	}
...
func cefingo_client_get_life_span_handler(
	...
	if f != nil {
		...
		Logf("T119.32: get_life_span_handler: Noo!")
	}
...
func cefingo_client_get_load_handler(
	...
	if f != nil {
		...
		Logf("T119.34: get_load_handler: Noo!")
	}
...
func cefingo_client_get_print_handler(
	...
	if f != nil {
		...
		Logf("T119.36: get_print_handler: Noo!")
	}
...
func cefingo_client_get_render_handler(
	...
	if f != nil {
		...
		Logf("T119.38: get_render_handler: Noo!")
	}
...
func cefingo_client_get_request_handler(
	...
	if f != nil {
		...
		Logf("T119.40: get_request_handler: Noo!")
	}
...
func cefingo_client_on_process_message_received(
	...
	Tracef(unsafe.Pointer(self), "T119.41:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T119.42: on_process_message_received: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser))        // byApi
...
// /
//
//export cefingo_context_menu_handler_run_quick_menu
func cefingo_context_menu_handler_run_quick_menu(
	self *C.cef_context_menu_handler_t,
	browser *C.cef_browser_t,
	frame *C.cef_frame_t,
	location *C.cef_point_t,
	size *C.cef_size_t,
	edit_state_flags C.cef_quick_menu_edit_state_flags_t,
	callback *C.cef_run_quick_menu_callback_t,
) (cRet C.int) {
	runtime.LockOSThread()
	defer runtime.UnlockOSThread()

	Tracef(unsafe.Pointer(self), "T122.13:")
	cefingoIfaceAccess.Lock()
	f := context_menu_handler_handlers.run_quick_menu_handler[(*cCContextMenuHandlerT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		goTmpframe := newCFrameT(frame, byApi)
		// !p.IsOutParam
		goTmplocation := (*CPointT)(location)
		// !p.IsOutParam
		goTmpsize := (*CSizeT)(size)
		// !p.IsOutParam
		goTmpedit_state_flags := CQuickMenuEditStateFlagsT(edit_state_flags)
		// !p.IsOutParam
		goTmpcallback := newCRunQuickMenuCallbackT(callback, byApi)

		goRet := f.RunQuickMenu(goTmpself, goTmpbrowser, goTmpframe, goTmplocation, goTmpsize, goTmpedit_state_flags, goTmpcallback)

		if goRet {
			cRet = 1
		}
	} else {
		Logf("T122.14: run_quick_menu: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser))               // byApi
	BaseRelease((*cCFrameT)(frame))                   // byApi
	BaseRelease((*cCRunQuickMenuCallbackT)(callback)) // byApi
...
// /
//
//export cefingo_context_menu_handler_on_quick_menu_command
func cefingo_context_menu_handler_on_quick_menu_command(
	self *C.cef_context_menu_handler_t,
	browser *C.cef_browser_t,
	frame *C.cef_frame_t,
	command_id C.int,
	...
	Tracef(unsafe.Pointer(self), "T122.15:")
	cefingoIfaceAccess.Lock()
	f := context_menu_handler_handlers.on_quick_menu_command_handler[(*cCContextMenuHandlerT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		goRet := f.OnQuickMenuCommand(goTmpself, goTmpbrowser, goTmpframe, goTmpcommand_id, goTmpevent_flags)

		if goRet {
			cRet = 1
		}
	} else {
		Logf("T122.16: on_quick_menu_command: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
	BaseRelease((*cCFrameT)(frame))     // byApi
...
// /
//
//export cefingo_context_menu_handler_on_quick_menu_dismissed
func cefingo_context_menu_handler_on_quick_menu_dismissed(
	self *C.cef_context_menu_handler_t,
	browser *C.cef_browser_t,
	frame *C.cef_frame_t,
) {
	...
	Tracef(unsafe.Pointer(self), "T122.17:")
	cefingoIfaceAccess.Lock()
	f := context_menu_handler_handlers.on_quick_menu_dismissed_handler[(*cCContextMenuHandlerT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		f.OnQuickMenuDismissed(goTmpself, goTmpbrowser, goTmpframe)

	} else {
		Logf("T122.18: on_quick_menu_dismissed: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
	BaseRelease((*cCFrameT)(frame))     // byApi
...
func cefingo_dev_tools_message_observer_on_dev_tools_message(
	...
	if f != nil {
		...
		goTmpbrowser := newCBrowserT(browser, byApi)
		// !p.IsOutParam
		goTmpmessage := unsafe.Slice((*byte)(message), message_size)
...
func cefingo_dev_tools_message_observer_on_dev_tools_method_result(
	...
	if f != nil {
		...
		goTmpsuccess := (int)(success)
		// !p.IsOutParam
		goTmpresult := unsafe.Slice((*byte)(result), result_size)
...
func cefingo_dev_tools_message_observer_on_dev_tools_event(
	...
	if f != nil {
		...
		// !p.IsOutParam
		goTmpparams := unsafe.Slice((*byte)(params), params_size)
...
// /
//
//export cefingo_display_handler_on_media_access_change
func cefingo_display_handler_on_media_access_change(
	self *C.cef_display_handler_t,
	browser *C.cef_browser_t,
	has_video_access C.int,
	has_audio_access C.int,
) {
	runtime.LockOSThread()
	defer runtime.UnlockOSThread()

	Tracef(unsafe.Pointer(self), "T132.25:")
	cefingoIfaceAccess.Lock()
	f := display_handler_handlers.on_media_access_change_handler[(*cCDisplayHandlerT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		goTmpbrowser := newCBrowserT(browser, byApi)
		// !p.IsOutParam
		goTmphas_video_access := (int)(has_video_access)
		// !p.IsOutParam
		goTmphas_audio_access := (int)(has_audio_access)

		f.OnMediaAccessChange(goTmpself, goTmpbrowser, goTmphas_video_access, goTmphas_audio_access)

	} else {
		Logf("T132.26: on_media_access_change: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
...
func cefingo_media_observer_on_sinks(
	...
	if f != nil {
		...
		slice := unsafe.Slice(sinks, sinksCount)
...
func cefingo_media_observer_on_routes(
	...
	if f != nil {
		...
		slice := unsafe.Slice(routes, routesCount)
...
func cefingo_render_handler_on_paint(
	...
	if f != nil {
		...
		slice := unsafe.Slice(dirtyRects, dirtyRectsCount)
...
// /
//
//export cefingo_render_handler_get_touch_handle_size
func cefingo_render_handler_get_touch_handle_size(
	self *C.cef_render_handler_t,
	browser *C.cef_browser_t,
	orientation C.cef_horizontal_alignment_t,
	size *C.cef_size_t,
) {
	runtime.LockOSThread()
	defer runtime.UnlockOSThread()
	...
	cefingoIfaceAccess.Lock()
	f := render_handler_handlers.get_touch_handle_size_handler[(*cCRenderHandlerT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		goTmpbrowser := newCBrowserT(browser, byApi)
		// !p.IsOutParam
		goTmporientation := CHorizontalAlignmentT(orientation)
		// !p.IsOutParam
		goTmpsize := (*CSizeT)(size)

		f.GetTouchHandleSize(goTmpself, goTmpbrowser, goTmporientation, goTmpsize)

	} else {
		Logf("T177.24: get_touch_handle_size: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
...
// /
//
//export cefingo_render_handler_on_touch_handle_state_changed
func cefingo_render_handler_on_touch_handle_state_changed(
	self *C.cef_render_handler_t,
	browser *C.cef_browser_t,
	state *C.cef_touch_handle_state_t,
) {
	runtime.LockOSThread()
	defer runtime.UnlockOSThread()
	...
	cefingoIfaceAccess.Lock()
	f := render_handler_handlers.on_touch_handle_state_changed_handler[(*cCRenderHandlerT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		goTmpbrowser := newCBrowserT(browser, byApi)
		// !p.IsOutParam
		goTmpstate := (*CTouchHandleStateT)(state)

		f.OnTouchHandleStateChanged(goTmpself, goTmpbrowser, goTmpstate)

	} else {
		Logf("T177.26: on_touch_handle_state_changed: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
...
func cefingo_render_handler_start_dragging(
	...
	if f != nil {
		...
		Logf("T177.28: start_dragging: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser))    // byApi
...
func cefingo_render_handler_update_drag_cursor(
	...
	if f != nil {
		...
		Logf("T177.30: update_drag_cursor: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
...
func cefingo_render_handler_on_scroll_offset_changed(
	...
	if f != nil {
		...
		Logf("T177.32: on_scroll_offset_changed: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
...
func cefingo_render_handler_on_ime_composition_range_changed(
	...
	if f != nil {
		...
		Logf("T177.34: on_ime_composition_range_changed: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
...
func cefingo_render_handler_on_text_selection_changed(
	...
	Tracef(unsafe.Pointer(self), "T177.35:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T177.36: on_text_selection_changed: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
...
func cefingo_render_handler_on_virtual_keyboard_requested(
	...
	Tracef(unsafe.Pointer(self), "T177.37:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T177.38: on_virtual_keyboard_requested: Noo!")
	}
	BaseRelease((*cCBrowserT)(browser)) // byApi
...
func cefingo_request_handler_on_select_client_certificate(
	...
	if f != nil {
		...
		slice := unsafe.Slice(certificates, certificatesCount)
...
func cefingo_resource_bundle_handler_get_data_resource(
	...
	if f != nil {
		...
		*data = (C.VOIDP)(c_calloc(*data_size, 1, "T188.8:cef_resource_bundle_handler_t::get_data_resource::data"))
		...
		target := unsafe.Slice((*byte)(*data), *data_size)
...
func cefingo_resource_handler_read(
	...
	if f != nil {
		...
		goTmpself := newCResourceHandlerT(self, byApi)
		// !p.IsOutParam
		goTmpdata_out := unsafe.Slice((*byte)(data_out), bytes_to_read)
		// !p.IsOutParam
...
func cefingo_response_filter_filter(
	...
	if f != nil {
		...
		goTmpself := newCResponseFilterT(self, byApi)
		// !p.IsOutParam
		goTmpdata_in := unsafe.Slice((*byte)(data_in), data_in_size)
		// !p.IsOutParam
		goTmpdata_out := unsafe.Slice((*byte)(data_out), data_out_size)
...
func cefingo_read_handler_read(
	...
	if f != nil {
		...
		// !p.IsOutParam
		goTmpptr := unsafe.Slice((*byte)(ptr), size*n)
		// !p.IsOutParam
...
func cefingo_urlrequest_client_on_download_data(
	...
	if f != nil {
		...
		goTmprequest := newCUrlrequestT(request, byApi)
		// !p.IsOutParam
		goTmpdata := unsafe.Slice((*byte)(data), data_length)
...
func cefingo_v8handler_execute(
	...
	if f != nil {
		...
		slice := unsafe.Slice(arguments, argumentsCount)
...
// /
//
//export cefingo_window_delegate_on_window_closing
func cefingo_window_delegate_on_window_closing(
	self *C.cef_window_delegate_t,
	window *C.cef_window_t,
) {
	runtime.LockOSThread()
	...
	cefingoIfaceAccess.Lock()
	f := window_delegate_handlers.on_window_closing_handler[(*cCWindowDelegateT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		f.OnWindowClosing(goTmpself, goTmpwindow)

	} else {
		Logf("T232.8: on_window_closing: Noo!")
	}
	BaseRelease((*cCWindowT)(window)) // byApi
...
func cefingo_window_delegate_on_window_destroyed(
	...
	if f != nil {
		...
		Logf("T232.10: on_window_destroyed: Noo!")
	}
	BaseRelease((*cCWindowT)(window)) // byApi
...
func cefingo_window_delegate_on_window_activation_changed(
	...
	if f != nil {
		...
		Logf("T232.12: on_window_activation_changed: Noo!")
	}
	BaseRelease((*cCWindowT)(window)) // byApi
...
// /
//
//export cefingo_window_delegate_on_window_bounds_changed
func cefingo_window_delegate_on_window_bounds_changed(
	self *C.cef_window_delegate_t,
	window *C.cef_window_t,
	new_bounds *C.cef_rect_t,
) {
	...
	cefingoIfaceAccess.Lock()
	f := window_delegate_handlers.on_window_bounds_changed_handler[(*cCWindowDelegateT)(self)]
	cefingoIfaceAccess.Unlock()
	...
	if f != nil {
		...
		f.OnWindowBoundsChanged(goTmpself, goTmpwindow, goTmpnew_bounds)

	} else {
		Logf("T232.14: on_window_bounds_changed: Noo!")
	}
	BaseRelease((*cCWindowT)(window)) // byApi
...
func cefingo_window_delegate_get_parent_window(
	...
	if f != nil {
		...
		*can_activate_menu = 0
		...
		Logf("T232.16: get_parent_window: Noo!")
	}
	BaseRelease((*cCWindowT)(window)) // byApi

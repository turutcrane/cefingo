...
func cefingo_browser_process_handler_on_schedule_message_pump_work(
	...
	if f != nil {
		...
		Logf("T112.11: on_schedule_message_pump_work: Noo!")
	}
...
func cefingo_browser_process_handler_get_default_client(
	...
	if f != nil {
		...
		Logf("T112.13: get_default_client: Noo!")
	}
...
func cefingo_browser_view_delegate_get_chrome_toolbar_type(
	...
	if f != nil {
		...
		Logf("T114.15: get_chrome_toolbar_type: Noo!")
	}
...
func cefingo_browser_view_delegate_on_layout_changed(
	...
	Tracef(unsafe.Pointer(self), "T114.30:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T114.31: on_layout_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_browser_view_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T114.32:")
	cefingoIfaceAccess.Lock()
...
func cefingo_browser_view_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T114.34:")
	cefingoIfaceAccess.Lock()
...
func cefingo_button_delegate_on_layout_changed(
	...
	if f != nil {
		...
		Logf("T116.25: on_layout_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_button_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T116.26:")
	cefingoIfaceAccess.Lock()
...
func cefingo_button_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T116.28:")
	cefingoIfaceAccess.Lock()
...
func cefingo_client_get_frame_handler(
	...
	if f != nil {
		...
		Logf("T119.23: get_frame_handler: Noo!")
	}
...
func cefingo_client_get_jsdialog_handler(
	...
	if f != nil {
		...
		Logf("T119.25: get_jsdialog_handler: Noo!")
	}
...
func cefingo_client_get_keyboard_handler(
	...
	if f != nil {
		...
		Logf("T119.27: get_keyboard_handler: Noo!")
	}
...
func cefingo_client_get_life_span_handler(
	...
	if f != nil {
		...
		Logf("T119.29: get_life_span_handler: Noo!")
	}
...
func cefingo_client_get_load_handler(
	...
	if f != nil {
		...
		Logf("T119.31: get_load_handler: Noo!")
	}
...
func cefingo_client_get_print_handler(
	...
	if f != nil {
		...
		Logf("T119.33: get_print_handler: Noo!")
	}
...
func cefingo_client_get_render_handler(
	...
	if f != nil {
		...
		Logf("T119.35: get_render_handler: Noo!")
	}
...
func cefingo_client_get_request_handler(
	...
	Tracef(unsafe.Pointer(self), "T119.36:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T119.37: get_request_handler: Noo!")
	}
...
func cefingo_client_on_process_message_received(
	...
	Tracef(unsafe.Pointer(self), "T119.38:")
	cefingoIfaceAccess.Lock()
...
func cefingo_menu_button_delegate_on_layout_changed(
	...
	if f != nil {
		...
		Logf("T165.27: on_layout_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_menu_button_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T165.28:")
	cefingoIfaceAccess.Lock()
...
func cefingo_menu_button_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T165.30:")
	cefingoIfaceAccess.Lock()
...
func cefingo_panel_delegate_on_layout_changed(
	...
	if f != nil {
		...
		Logf("T170.21: on_layout_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_panel_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T170.22:")
	cefingoIfaceAccess.Lock()
...
func cefingo_panel_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T170.24:")
	cefingoIfaceAccess.Lock()
...
func cefingo_textfield_delegate_on_layout_changed(
	...
	if f != nil {
		...
		Logf("T209.25: on_layout_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_textfield_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T209.26:")
	cefingoIfaceAccess.Lock()
...
func cefingo_textfield_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T209.28:")
	cefingoIfaceAccess.Lock()
...
func cefingo_view_delegate_on_layout_changed(
	...
	if f != nil {
		...
		Logf("T226.21: on_layout_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_view_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T226.22:")
	cefingoIfaceAccess.Lock()
...
func cefingo_view_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T226.24:")
	cefingoIfaceAccess.Lock()
...
func cefingo_web_plugin_info_visitor_visit(
	...
	if f != nil {
		// !p.IsOutParam
		goTmpself := newCWebPluginInfoVisitorT(self, byApi)
		// !p.IsOutParam
		goTmpinfo := newCWebPluginInfoT(info, byApi)
		// !p.IsOutParam
		goTmpcount := (int)(count)
		// !p.IsOutParam
		goTmptotal := (int)(total)
...
func cefingo_web_plugin_unstable_callback_is_unstable(
	...
	if f != nil {
		// !p.IsOutParam
		goTmpself := newCWebPluginUnstableCallbackT(self, byApi)
		// !p.IsOutParam
		goTmppath := string_from_cef_string(path)
		// !p.IsOutParam
...
func cefingo_window_delegate_get_initial_show_state(
	...
	if f != nil {
		...
		Logf("T232.15: get_initial_show_state: Noo!")
	}
	BaseRelease((*cCWindowT)(window)) // byApi
...
func cefingo_window_delegate_on_accelerator(
	...
	if f != nil {
		...
		Logf("T232.27: on_accelerator: Noo!")
	}
	BaseRelease((*cCWindowT)(window)) // byApi
...
func cefingo_window_delegate_get_preferred_size(
	...
	if f != nil {
		...
		Logf("T232.31: get_preferred_size: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_window_delegate_get_minimum_size(
	...
	if f != nil {
		...
		Logf("T232.33: get_minimum_size: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_window_delegate_get_maximum_size(
	...
	if f != nil {
		...
		Logf("T232.35: get_maximum_size: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_window_delegate_get_height_for_width(
	...
	if f != nil {
		...
		Logf("T232.37: get_height_for_width: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_window_delegate_on_parent_view_changed(
	...
	if f != nil {
		...
		Logf("T232.39: on_parent_view_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view))   // byApi
	BaseRelease((*cCViewT)(parent)) // byApi
...
func cefingo_window_delegate_on_child_view_changed(
	...
	if f != nil {
		...
		Logf("T232.41: on_child_view_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view))  // byApi
	BaseRelease((*cCViewT)(child)) // byApi
...
func cefingo_window_delegate_on_window_changed(
	...
	if f != nil {
		...
		Logf("T232.43: on_window_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_window_delegate_on_layout_changed(
	...
	Tracef(unsafe.Pointer(self), "T232.44:")
	cefingoIfaceAccess.Lock()
	...
	if f != nil {
		...
		Logf("T232.45: on_layout_changed: Noo!")
	}
	BaseRelease((*cCViewT)(view)) // byApi
...
func cefingo_window_delegate_on_focus(
	...
	Tracef(unsafe.Pointer(self), "T232.46:")
	cefingoIfaceAccess.Lock()
...
func cefingo_window_delegate_on_blur(
	...
	Tracef(unsafe.Pointer(self), "T232.48:")
	cefingoIfaceAccess.Lock()
